var obj = [{"id":1,"city":"Melun","phone":"457-689-6321","state":"Île-de-France","country":"France"},
...
for (let i = 0; i < obj.length; i++) {
    document.getElementById("demo").innerHTML = document.getElementById("demo").innerHTML + "<option>" + obj[i].country + "</option>";
}
for (let i = 0; i < obj.length; i++) {
    document.getElementById("demo1").innerHTML = document.getElementById("demo1").innerHTML + "<option>" + obj[i].state + "</option>";
}
for (let i = 0; i < obj.length; i++) {
    document.getElementById("demo2").innerHTML = document.getElementById("demo2").innerHTML + "<option>" + obj[i].city + "</option>";
}
function filter()
{
    document.getElementById("filter").innerHTML = "<tr><td>ID</td><td>PHONE</td></tr>";
    let obj1 = document.getElementById("demo").value;
    let obj2 = document.getElementById("demo1").value;
    let obj3 = document.getElementById("demo2").value;
    for(let i = 0;i<obj.length;i++){
        if(obj1 == obj[i].country)  
        {
            document.getElementById("filter").innerHTML = document.getElementById("filter").innerHTML + "<tr><td>"+obj[i].id+"</td><td>"+ obj[i].phone+"</td></tr>";
        }
        if(obj2 == obj[i].state)
        {
            document.getElementById("filter").innerHTML = document.getElementById("filter").innerHTML + "<tr><td>"+obj[i].id+"</td><td>"+ obj[i].phone+"</td></tr>";
